...
<head>
    ...
    <title>Blocked Sponsor List</title>
    ...
    <script type="text/javascript">
        function load_modal(id)
        {
            ...
            success: function(response)
            {
                ...
                $('#crate').html(response[0].scommissionrate);
            }
            });
        }
        
        var spid;
        function load_unblock_sponsor(sid)
        {
            swal({
                title:"Are you sure?",
                type:"warning",
                ...
                spid = sid;
                final_unblock_sponsor();
                swal("Unblocked!","<span style='font-size:20px;font-weight:bold;'>Sponsor has been Unblocked...</span>","success")
            })
        }

        function final_unblock_sponsor()
        {
            $.ajax({
                url: "<?php echo site_url('Controller/unblock_sponsor/');?>"+spid,
                type:"POST",
                success:function(response)
                {
                                ...
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <table id="datatable" class="table table-bordered text-center table-hover">
                                            ...
                                            <tbody>
                                                <?php 
                                                    $res=$this->Model->model_select('sponsortb',array('status'=>0));
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="javascript:load_unblock_sponsor(<?php echo $value->sponsor_code ?>)"><i class="mdi mdi-block-helper" style="font-size:15px;color:red;"></i></a>  
                                                            </td>
                                                        </tr>
                                                    <?php
                                                    }
                                ...
                                <div id="tabsJustifiedContent" class="tab-content">
                                    <div id="profile" class="tab-pane fade active show">
                                        <div class="row pb-2">
                                            ...
                                            <div class="col-md-4">
                                                <img src='<?php echo base_url();?>/assets/uploads/sponsorprofile/<?php echo $value->sprofile?>' class="float-right img-fluid img-rounded">
                                            </div>
                                        </div>
                                    </div>
