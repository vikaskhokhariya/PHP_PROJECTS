<?php 
    $admins=$this->Model->model_select('admintb',array('allowed'=>1,'status'=>1,'type'=>'sub'));
    $totaladmins=sizeof($admins);
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="mini-stat clearfix bg-white">
                                    <span class="mini-stat-icon bg-light">
                                        <i class="ion-ios7-person text-danger"></i>
                                    </span>
                                    ...
                                    <div class="mini-stat-info text-right text-light">
                                        <span class="counter text-danger">
                                            Total : <?php echo $totaladmins; ?>
                                        </span>
                                    </div>
                                    <p class="mb-0 m-t-20 text-danger">
