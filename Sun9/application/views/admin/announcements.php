...
<body class="fixed-left" id="top">
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                            <button type="button" name="csubmit" value="csubmit" class="btn btn-info btn-block" id="submit" onclick="add_Announcements()">Submit</button>
                                        </div>
                                        <div class="col-sm-2">
    ...
    <script type="text/javascript">
        ...
        function add_Announcements()
        {
            ...
            fd.append('atitle',atitle);

            if(summernote!=='<p><br></p>')
            {
                $.ajax({
                    url : "<?php echo site_url('Controller/addAnnouncements'); ?>",
                    data : fd,
                    dataType : "JSON",
                    type : "POST",
                    processData:false,
                    ...
                    success : function(response)
                    {
                        ...
                        if(response.ans==0)
                        {
                            swal({
                            title:"Opps..",
                            text:"<span style='font-size:20px;font-weight:bold;'>Please Enter the Announcement Title...</span>",
                            type:"error"
                            });
                        }
                        else
            ...
            {
                if(summernote=='<p><br></p>' && atitle=='')
                {
                    swal({
                        title:"Opps..",
                        text:"<span style='font-size:20px;font-weight:bold;'>Please Enter the Announcement Title...<br>Please Enter the Announcement...</span>",
                        type:"error"
                        });
                ...
                else
                {
                    swal({
                        title:"Opps..",
                        text:"<span style='font-size:20px;font-weight:bold;'>Please Enter the Announcement...</span>",
                        type:"error"
                        });
                }
            }
