...
<head>
        ...
        <title>Promoter Commision</title>
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-title-box">
                                        <h4 class="page-title" style="color:black;">Search Promoter</h4>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row form-group text-center"> 
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-3">
                                                    <input type="button" value="Reset" name="reset" class="btn btn-success btn-block" id="reset">
                                                </div>
                                                <div class="col-3">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            <h4 class="page-title" style="color:black;">Promoter Commission</h4>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        <script type="text/javascript">
            function show()
             {
                $.ajax({
                    url : "<?php echo site_url('Controller/load_search_data_commission');?>",
                    type : "POST",
                    success : function(response)
                    {
            ...
            var pcode=pname='';
             $(function(){
                ...
                if((pcode=='undefined') && (pname=='undefined'))
                {
                    swal({
                        width:"35%",
                        title:"Opps..",
                ...
                {
                    $.ajax({
                        url: "<?php echo site_url('Controller/load_search_data_commission/');?>"+pcode+"/"+pname,
                        type:"POST",
                        success : function(response)
                        {
                            console.log(response);
