    ...
    <script type="text/javascript">
        ...
        function login_admin()
        {
            ...
            formdata={
             ...
             $.ajax({
                url : "<?php echo site_url('Controller/loginadmin');?>",
                data : formdata,
                type : "POST",
                dataType : "JSON",
                ...
                success : function(response)
                {
                    ...
                    if(response.code==1)
                    {
                        $('#loginalert').slideDown(1000).delay(2000).slideUp(1000);
                    }
                    else
                    {
                        if(response.msg=='master')
                        {
                            window.location.href="load_masteradmindashboard";
                        }
                        else
                        {
                            window.location.href="load_subadmindashboard";
                        }
                    }
                }
            });
