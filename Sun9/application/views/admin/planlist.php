...
<body class="fixed-left">
                                ...
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <table id="datatable" class="table table-bordered text-center">
                                            ...
                                            <?php 
                                                $res=$this->Model->model_select('plantb',array('allowed'=>1));
                                            ?>
                                            <tbody>
                                                <?php 
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $value->pricepersfeet; ?></td>
                                                            <td><?php echo $value->pvalidity; ?></td>
                                                            <td>
                                                               <a href="javascript:load_edit_plan('<?php echo $value->plan_code; ?>')"><i class="mdi mdi-grease-pencil" style="font-size:15px;color:green;"></i></a>
                                                               &nbsp;
                                                                <a href="javascript:load_delete_plan(<?php echo $value->plan_code?>)">
    ...
    <script type="text/javascript">
        ...
        function addnewplan()
        {
            window.location.href="load_addplan";
        }
    </script>
