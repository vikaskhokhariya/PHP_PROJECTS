                    ...
                    <div class="col-lg-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Students For Demo List</h3>
                            </div>
                            <div class="box-body">
                                <div class="table-responsive">
                                    ...
                                    <?php 
                                        $result=$this->Model->model_select('tbl_demo',array('status'=>1),'demo_id','desc');
                                        $count = 1;
                                    ?>
                                    <tbody>
                                        <?php 
                                        foreach($result as $value)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-block btn-success btn-xs" href="<?php echo base_url(); ?>Demo/Demo_Students/<?php echo $value->demo_id; ?>">
                                                        <span style="color:white;">Enroll<span>
                                                    </a>
                                                    <a class="btn btn-block btn-danger btn-xs" href="javascript:cancel_demo('<?php echo $value->demo_id; ?>')">
