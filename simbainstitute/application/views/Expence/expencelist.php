                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <table id="example" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                    ...
                                    <?php 
                                        $result=$this->Model->model_select('tbl_expence','','expence_id','desc');
                                        $count = 1;
                                    ?>
                                    <tbody>
                                        <?php 
                                        foreach($result as $value)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $expencetitle[0]->expence_category; ?></td>
                                                <td><?php echo $value->expence_detail; ?></td>
                                                <td><?php echo $value->expence_amount; ?></td>
                                                <td><?php echo $value->expence_date; ?></td>
                                                <td class="text-center">
                                                    <a href="<?php echo base_url(); ?>Expence/Edit_Expence/<?php echo $value->expence_id; ?>"><i class="fa fa-pencil-square-o fa-lg" aria-hidden="true" style="color:#00c292;"></i>
                                                    </a>

                                                    &nbsp;&nbsp;

                                                    <a href="javascript:delete_record('<?php echo $value->expence_id; ?>')"><i class="fa fa-trash fa-lg" aria-hidden="true" style="color:#EF5350;"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                            <?php
...
<script type="text/javascript">
    function delete_record(expence_id)
    {
        swal({
            title: 'Are you sure?',
            ...
            {
                $.ajax({
                    url:"<?php echo site_url('Expence/delete_expence/') ?>"+expence_id,
                    type:'POST',
