                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 w-p100" id="expencetitle">
                                            ...
                                            <?php 
                                                ...
                                                {
                                                ?>
                                                    <option value="<?php echo $value->expence_category_id; ?>">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea id="expencedetail" class="form-control" rows="4" placeholder="Enter Expence Detail"></textarea>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="expenceamount" placeholder="Enter Expence Amount" autocomplete="off">
...
<script type="text/javascript">
    $('#sbmt').click(function(){
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>Expence/addnewexpence",
            data:f,
            dataType:"JSON",
            type:"POST",
            processData:false,
            ...
            success : function(response)
            {
                ...
                else
                {
                    swal({
                        title:"Good Job",
                        text:"Expence Inserted SuccessFully",
                        type:"success",
                        allowOutsideClick: false,
                        animation: false,
