...
<body class="vertical-layout vertical-menu-modern 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-color="bg-gradient-x-purple-red" data-col="2-columns">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-4 col-12">
                    <a class="btn btn-warning btn-min-width float-md-right box-shadow-4 mr-1 mb-1" href="<?php echo base_url(); ?>Admin_cnt/load_addmaincat">
                                                ...
                                                <tbody>
                                                    <?php 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?php echo base_url(); ?>Admin_cnt/edit_maincategory/<?php echo $value->cat_id;?>">
                                                                    <i class="fa fa-edit" style="font-size:15px;color:green;">
                                                                    </i>
                                                                </a>
                                                                &nbsp;
                                                                <a href="javascript:del_category('<?php echo $value->cat_id;?>')">
    ...
    <script type="text/javascript">
        ...
        {
            $.ajax({
                url:'<?php echo base_url();?>Admin_cnt/del_maincategory/'+catid,
                type:'POST',
                success:function(response)
                {
                    if(response=='success')
                    {
                        ...
                        $('.swal2-confirm').click(function(){
                            window.location.href='load_maincatlist';
                        });
                    }
                    else
                    {
