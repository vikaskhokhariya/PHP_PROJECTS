...
<body class="vertical-layout vertical-menu-modern 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-color="bg-gradient-x-purple-red" data-col="2-columns">
                                                    ...
                                                    <form class="form">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-5">
                                                                    <input class="form-control" type="text" placeholder="Enter Category Name" id="cnm" autocomplete="off">
                                                                </div>
                                                            ...
                                                            <div class="form-actions">
                                                                <input type="button" name="submit" value="Submit" class="btn btn-info" onclick="add_maincategory()"> 
    ...
    <script type="text/javascript">
        ...
        function add_maincategory()
        {
            ...
            $.ajax({
                url : "<?php echo site_url('Admin_cnt/add_maincategory'); ?>",
                data: f,
                dataType : "JSON",
                type: "POST",
                processData: false,
                ...
                success : function(response)
                {
                    ...
                    if(response.code===0)
                    {
                        if(response.msg=="record is already present")
                        {
                            $('#cnameerror').html('Record is Already Present').slideDown('slow');
                            $('#cnm').val('');
                        }
                        else
                        {
