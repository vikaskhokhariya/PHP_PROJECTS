...
<body class="vertical-layout vertical-menu-modern 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-color="bg-gradient-x-purple-red" data-col="2-columns">
                                                    ...
                                                    <form class="form">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-5">
                                                                    <input class="form-control" type="text" placeholder="Enter Category Title" id="ctitle" autocomplete="off" value="<?php echo $result[0]->blog_title; ?>">
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-5">
                                                                    <img class="img-thumbnail img-fluid" src="<?php echo base_url(); ?>Upload/Admin/Blog/<?php echo $result[0]->blog_image; ?>" height="150px" width="150px" id="catimg">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                               ...
                                                               <div class="form-group col-sm-8">
                                                                    <textarea name="ckeditor" id="ckeditor" cols="30" rows="15" class="ckeditor"><?php echo $result[0]->blog_content; ?></textarea>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-actions">
                                                                <input type="button" name="submit" value="Submit" class="btn btn-info" onclick="edit_blog(<?php echo $result[0]->blog_id; ?>)"> 
    ...
    <script type="text/javascript">
        ...
        function edit_blog(blogid)
        {
            ...
            $.ajax({
                url : "<?php echo site_url('Admin_cnt/edit__blog/'); ?>"+blogid,
                data: f,
                dataType : "JSON",
                type: "POST",
                processData: false,
