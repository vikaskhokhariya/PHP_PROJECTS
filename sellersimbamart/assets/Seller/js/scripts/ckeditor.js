...
(function () {
			...
			on: function (b, d, h, k, g) {
				...
				if (0 > e.getListenerIndex(d)) {
					...
					for (var v = e.length - 1; 0 <= v; v--)
						if (e[v].priority <= g) return e.splice(v + 1, 0, n), {
							removeListener: r
						};
					e.unshift(n)
				}
			...
			fire: function () {
				...
				return function (g, n, r) {
					...
					if (e) {
						var v = e.listeners;
						if (v.length)
							for (var v = v.slice(0), B, D = 0; D < v.length; D++) {
								if (e.errorProof) try {
									B =
										v[D].call(this, r, n, b, k)
								} catch (x) {} else B = v[D].call(this, r, n, b, k);
				...
				for (this._.nextNode = null; m;) {
					...
					if (K) m.type == CKEDITOR.NODE_TEXT && f.test(m.getText()) && (K = 0);
						...
						if (CKEDITOR.dtd.$block[t] && "false" == m.getAttribute("contenteditable")) {
							...
							if ("br" == t) K = 1;
							else if (!k && !m.getChildCount() && "hr" != t) {
								d = m;
								v = m.equals(x);
								break
							}
	...
	(function () {
		function a(a, b, c, d, f) {
			...
			for (e in b) {
				w = b[e];
				w = "boolean" == typeof w ? {} : "function" == typeof w ? {
					match: w
				} : E(w);
		...
		function B(a, b, f, e) {
			...
			if (e.doCallbacks && a.elementCallbacks) {
				a: {
					...
					for (var h = 0, q = p.length, E; h < q; ++h)
						if (E = p[h](b)) {
							p = E;
							break a
						}
			...
			if (e.doFilter) {
				a: {
					...
					if (a || p) {
						...
						if (q)
							for (g = 0, k = q.length; g < k; ++g) c(q[g], b, z);
						if (a)
							for (g = 0, k = a.length; g < k; ++g) d(a[g], b, z, E);
						if (p)
		...
		function l(a, b, c) {
			...
			if (q.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(u()) : (a.parent && c.push({
				...
				if ("br" == b) a.previous && !K(a.previous) && (b = u(), b.insertBefore(a)), a.next && !K(a.next) && (b = u(), b.insertAfter(a)), a.replaceWithChildren();
					...
					b: {
						f = q[b];
						for (var e = 0, l = d.length, w; e < l; ++e)
		...
		function F(a, b) {
			...
			for (e in d)
				if ("class" == e)
					for (c = d[e].split(/\s+/), w = a.classes.join("|"); p = c.pop();) {
			...
			transform: function (a, b) {
				if ("string" == typeof b) a.name = b;
					...
					for (e in f)
						if ("class" == e)
							for (c =
								a.classes.join("|"), w = f[e].split(/\s+/); p = w.pop();) - 1 == c.indexOf(p) && a.classes.push(p);
			...
			CKEDITOR.plugins.load(d.split(","),
				function (b) {
					...
					for (var l in b) {
						...
						if (p && (F = p.match(g)))
							for (; p = F.pop();) CKEDITOR.error("editor-plugin-required", {
								plugin: p.replace(",", ""),
								requiredBy: l
							});
		...
		x = function () {
			...
			function b(c, d) {
				...
				for (var z = E[z.getName()], k = 0, H = c.getChildren(), m = H.count(), n = -1, r = -1, C = 0, P = e.contains(E.$list); k < m; ++k) e = H.getItem(k), a(e) ? (g =
					...
					node: e,
					allowed: 1
				}); - 1 < n && (h[n].firstNotAllowed = 1); - 1 < r && (h[r].lastNotAllowed = 1);
				return h
			}
				...
				for (q.getPosition(t) == CKEDITOR.POSITION_FOLLOWING && (q = 0); q;) {
					...
					if (q.equals(t)) q = null, l = !0;
						...
						if (x && m && CKEDITOR.dtd.$block[y])
							for (var C = q, E = f(C), F = void 0, H = E.length, K = 0, C = H && new CKEDITOR.dom.range(C.getDocument()); K < H; ++K) {
								var F = E[K],
					...
					if (n && f) {
						if (c && (c.is("li") || c.getParent().is("li"))) {
							...
							if (d.is("li")) g || f ? (g && f && b.remove(), c[f ? "insertAfter" : "insertBefore"](d)) : c.breakParent(d);
								...
								if (a)
									if (p.block.is("li") ? (d = h.createElement(e == CKEDITOR.ENTER_P ? "p" : "div"), r && d.setAttribute("dir", k), q && d.setAttribute("style", q), t && d.setAttribute("class",
											t), c.moveChildren(d)) : d = p.block, g || f) d[g ? "insertBefore" : "insertAfter"](b);
				...
				for (l = 0; l < c.length; l++)
					for (k = new CKEDITOR.dom.element(g.$.rows[a.rows.first.$.rowIndex + l]), p = 0; p < c[l].length; p++)
						if (f = new CKEDITOR.dom.element(c[l][p]), d = b[l] && b[l][p] ? new CKEDITOR.dom.element(b[l][p]) : null, f && !f.getCustomData("processed")) {
							...
							else if (0 === p || c[l][p - 1])(d = 0 !== p ? new CKEDITOR.dom.element(c[l][p -
								1
							]) : null) && k.equals(d.getParent()) ? f.insertAfter(d) : 0 < e ? k.$.cells[e] ? f.insertAfter(new CKEDITOR.dom.element(k.$.cells[e])) : k.append(f) : k.append(f, !0);
