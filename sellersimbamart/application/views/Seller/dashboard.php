<?php 
    $enq_result=$this->Model->model_select('simbamart.tbl_enquiry');
    $total_enquiry=count($enq_result);

    $maincat_result=$this->Model->model_select('simbamart.tbl_category',array('type'=>'main','cat_status'=>1));
    $total_maincat=count($maincat_result);

    $subcat_result=$this->Model->model_select('simbamart.tbl_category',array('type'=>'main','cat_status'=>1));
