...
<body class="vertical-layout vertical-menu-modern 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-color="bg-gradient-x-purple-red" data-col="2-columns">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">
                        EDIT PRODUCT (<?php echo $productresult[0]->product_name; ?>)
                    </h3>
                                                    ...
                                                    <form class="form">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-5">
                                                                    <input class="form-control" type="text" placeholder="Enter Product Name" id="productname" autocomplete="off" value="<?php echo $productresult[0]->product_name; ?>">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-2">
                                                                    <img class="img-thumbnail img-fluid" src="<?php echo base_url(); ?>Upload/Seller/<?php echo $this->session->userdata("sellerid"); ?>/Product/<?php echo $productresult[0]->primary_image; ?>" height="150px" width="150px" id="productimage">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input class="form-control border-primary" type="text" placeholder="EX - 1000" id="productprice" value="<?php echo $productresult[0]->price; ?>">
                                                                    </div>
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <input class="form-control" type="text" placeholder="EX - Piece / Pair" id="unittype" autocomplete="off" value="<?php echo $productresult[0]->unit_type; ?>">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <input class="form-control" type="text" placeholder="Ex - 50" id="minqty" autocomplete="off" value="<?php echo $productresult[0]->min_qty; ?>">
                                                            ...
                                                            <div class="form-group row">
                                                               ...
                                                               <div class="form-group col-sm-8">
                                                                    <textarea name="ckeditor" id="ckeditor" cols="30" rows="15" class="ckeditor"><?php echo $productresult[0]->description; ?></textarea>
                                                                ...
                                                                <div class="col-sm-5">
                                                                    <select class="form-control" id="maincategory">
                                                                        ...
                                                                        <?php 
                                                                           ...
                                                                           {
                                                                        ?>
                                                                            <option value="<?php echo $q->cat_id;?>" <?php if($q->cat_id==$productresult[0]->maincatid) echo 'selected'; ?>><?php echo $q->cat_name;?></option>
                                                                        <?php
                                                                           }
                                                                        ?>
                                                                    </select> 
                                                            ...
                                                            <div class="form-actions">
                                                                <button type="button" class="btn btn-info" onclick="update_product(<?php echo $productresult[0]->product_id; ?>)">Submit</button>
                                                                <input type="button" value="Cancel" class="btn btn-danger mr-1" id="canceleditproduct">
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function()
        {
            ...
            $.ajax({
                url : "<?php echo base_url();?>Product/find_subcategorylist/"+maincatid,
                type: "POST",
                success : function(response)
                {
                    document.getElementById('subcategory').innerHTML=response;
                    $('#subcategory').val(<?php echo $productresult[0]->subcatid; ?>);
                }
            });
        });
        ...
        $('#productimageselect').change(function()
        {
            ...
            {
                updateprimaryimage = $('#productimageselect')[0].files[0];
                readURL(this);
            }
        });
